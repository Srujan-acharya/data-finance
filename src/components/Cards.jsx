  ...
  return (
    ...
    <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8 '>
        <div className='w-full shadow-xl flex flex-col p-4 rounded-lg hover:scale-105 duration-300'>
            ...
            <button className='bg-[#00df9a] rounded-md w-[200px] mx-auto px-6 py-3 my-6 font-medium hover:scale-105 duration-200'>Start Trail</button>
        </div>
        <div className='w-full shadow-xl flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
            ...
            <button className='bg-black text-white rounded-md w-[200px] mx-auto px-6 py-3 my-6 font-medium hover:scale-105 duration-200'>Start Trail</button>
        </div>
